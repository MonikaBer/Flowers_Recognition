...
def show_cam_on_image(name, img, mask):
...
if __name__ == '__main__':
    ...
    model = torch.load('./drive/My Drive/2cd/2c_trained_model.pt')
    #model = torch.load('./drive/My Drive/2cd/2d_trained_model.pt')
    ...
    show_cam_on_image(name, img, mask)
